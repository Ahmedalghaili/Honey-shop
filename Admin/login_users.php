...
if (isset($_POST['login'])) {
    $username = $_POST['form3Example3'];
    $password = $_POST['form3Example4'];
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            $_SESSION['user_id'] = $user['user_id']; // Login successful
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form action="./login_users.php" method="POST">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="email" id="form3Example3" name="form3Example3" class="form-control form-control-lg"
